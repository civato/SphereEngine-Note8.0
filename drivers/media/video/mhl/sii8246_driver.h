...
#define MHL_TX_TMDS_TERMCTRL1               0x13
#define MHL_TX_TMDS_CTRL1               0x45
#define MHL_TX_TMDS_CTRL7               0x4B
...
#ifdef CONFIG_SAMSUNG_MHL_9290
static int sii8246_30pin_init_for_9290(struct sii8246_data *sii8246);
void sii8246_tmds_reset(void);
void sii8246_tmds_reset_work(struct work_struct *work);
#endif
